...
@WebServlet("/AIntra")
public class AIntra extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String CHAMP_INTRA = "identifiant_intra";
	
	public static final String ATT_ERREUR = "erreur_intra";
	...
	{ /*Traitement des donn�es du formulaire */
		String identifiant = request.getParameter(CHAMP_INTRA);
		...
		else
		{
			...
			membre.setIntra(identifiant);
			userdao.updateSkype(membre);
			message = "Connexion � Intra d'Epitech -> Ok! <br>";
			erreur = false;
		}
