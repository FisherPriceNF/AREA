		...
		<div class="div_formulaire">
				...
				<!-- Formulaire -->
					<form class="login" method="post" action="<c:url value='/'/>">
						<input id="email" class="input_text mail" name="email" type="email" placeholder="Mail" />
						<input id="pass" class="input_text pass" name="pass" type="password" placeholder="Password" maxlength="8" /><br/>			
						<a class="lien_enregistre" id="lien_enregistre" href="<c:url value='/signUp'/>">Créer un compte</a>
