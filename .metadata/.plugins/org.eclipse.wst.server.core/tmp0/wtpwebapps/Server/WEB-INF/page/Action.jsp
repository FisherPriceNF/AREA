		...
		<div class="div_formulaire">
				<!-- Formulaire -->
					<form class="facebook" method="post" action="<c:url value='/action/facebook'/>">
						...
						<input id="identifiant_facebook" class="input_text mail" name="identifiant_facebook" type="email" placeholder="Facebook" />
		...
		<div class="div_formulaire">
				<!-- Formulaire -->
					<form class="twitter" method="post" action="<c:url value='/action/twitter'/>">
						...
						<input id="identifiant_twitter" class="input_text util" name="identifiant_twitter" type="text" placeholder="Twitter" />
		...
		<div class="div_formulaire">
				<!-- Formulaire -->
					<form class="intra" method="post" action="<c:url value='/action/intra'/>">
						...
						<input id="identifiant_intra" class="input_text mail" name="identifiant_intra" type="email" placeholder="Intranet Epitech" />
		...
		<div class="div_formulaire">
				<!-- Formulaire -->
					<form class="yammer" method="post" action="<c:url value='/action/yammer'/>">
						...
						<input id="identifiant_yammer" class="input_text mail" name="identifiant_yammer" type="email" placeholder="Yammer" />
		...
		<div class="div_formulaire">
				<!-- Formulaire -->
					<form class="skype" method="post" action="<c:url value='/action/skype'/>">
						...
						<input id="identifiant_skype" class="input_text util" name="identifiant_skype" type="text" placeholder="Skype" />
