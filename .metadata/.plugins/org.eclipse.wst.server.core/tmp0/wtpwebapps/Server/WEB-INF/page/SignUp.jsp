   ...
   <head>
	...
	<body>
		<div class="div_formulaire">
			<div class="div_logo">
				<img class="logo" src="https://upload.wikimedia.org/wikipedia/fr/thumb/b/bb/AREA.svg/727px-AREA.svg.png" width="auto" height="auto" alt="logo"/>
			</div>
			...
			<!-- Formulaire -->
				<form class="signUp" method="post" action="<c:url value='/signUp'/>">
					...
					<div class="top-row">
					<input id="email" name="email" type="email" placeholder="Mail" class="input_text mail"/><br/>
					</div> <!-- !top-row -->
				
					<div class="top-row">					
					<input id="pass" name="pass" type="password" placeholder="Mot de passe" maxlength="8" class="input_text pass"/><br/>
					</div> <!-- !top-row -->
